"""
Django settings for aaaaaa_12 project.
...
WSGI_APPLICATION = 'aaaaaa_12.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aaaaaa_12 API",
    "DESCRIPTION": "API documentation for aaaaaa_12 App",
    "VERSION": "v1",
}
